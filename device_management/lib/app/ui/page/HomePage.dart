...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: buildSearchBar()), body: buildFeedList());
  }
...
//              Log.info('index : $index');
                      ...
                      bool isFeatureListItemExist =
                          HomeListType.TYPE_FEATURE == feedList[0].type;
                      ...
                      return StreamListItem<HomeListItem, num>(
                          ...
                          builder:
                              (BuildContext context, HomeListItem listItem) {
//                    Log.info('Updated : $index');
                            return buildTopAppListItem(
                                listItem, index, isFeatureListItemExist);
                          });
                    });
              }
          }
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                      ...
                      margin: EdgeInsets.only(
                          left: 16,
                          right: index == featureListItem.entryList.length - 1
                              ? 16
                              : 0),
                      child: InkWell(
                          onTap: () {
                            AppProvider.getRouter(context).navigateTo(
                                context,
                                AppDetailPage.generatePath(app.trackId, heroTag,
                                    titleTag, name, app.artworkUrl100),
  ...
  Widget buildTopAppListItem(
      TopAppListItem listItem, int index, bool isFeatureListItemExist) {
        ...
        Container(
            ...
            child: InkWell(
                onTap: () {
                  AppProvider.getRouter(context).navigateTo(
                      context,
                      AppDetailPage.generatePath(app.trackId, heroTag, titleTag,
                          name, app.artworkUrl100),
                      transition: TransitionType.fadeIn);
                },
                child: Row(
                  mainAxisSize: MainAxisSize.max,
